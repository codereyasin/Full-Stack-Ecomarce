        ...
        <div className="p-5">
            <div className="mx-auto max-w-[350px] rounded-md bg-gray-200 my-10 p-5">
                <div className="flex items-center gap-5 text-2xl font-semibold justify-center uppercase pb-4 border-b border-b-gray-300">
                    <h1 className={`${isLogin ? 'text-gray-700' : 'text-gray-400'} cursor-pointer text-2xl`} onClick={() => setIsLogin(true)}>Login</h1>
                    <h1 className={`${!isLogin ? 'text-gray-700' : 'text-gray-400'} cursor-pointer text-2xl`} onClick={() => setIsLogin(false)}>Register</h1>
                </div>
                <div className="py-5">
